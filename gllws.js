...
      est('D','plv','<select id="tema"><option value="geral">Geral</option><option value="frutas">Frutas</option><option value="cidadesDeGoiás">Cidades</option><option value="geral" selected disabled>escolha um TEMA</option></select><br>');
      est('D','txt','');
      btn('INICIAR', 'fjg()');
      
}
...
*/
function fjg(t){
      if(tema==null){tema = document.getElementById("tema").value;}
      sctp();
...
function temas(tema){
      if(tema=='geral'){return grl;}
      if(tema=='frutas'){return frts;}
      if(tema=='cidadesDeGoiás'){return cdGO;}
}
...
      plvr = srt(temas(tema));console.log(tema + plvr);
